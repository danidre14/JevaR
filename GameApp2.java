    ...
    public static void main(String[] args) {
        ...
        new JevaR(initWidth, initHeight, initFps, (jevar) -> {
            ...
            jevar.createPrefab("player1", initWidth - 100, 350, 100, 100, (loaded_self) -> {
                ...
                loaded_clip.setAnchorX(0.5);
                loaded_clip.setAnchorY(0.5);
            ...
            jevar.createText("textfield1", "Hello World", 0, 0, 300, 100,
                    (loaded_self) -> {
                        ((JevaText) loaded_self)._fontSize = 24;
                        ((JevaText) loaded_self)._x = initWidth / 2;
                        ((JevaText) loaded_self)._y = 40;
                        ((JevaText) loaded_self).setAnchorX(0.5);
            ...
            // clip.setAnchorX(clip.getAnchorX() + nn);
            // }
            // // System.out.println(clip._scaleX + ":" + clip._scaleY);
